...
class ZombiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zombie" do
    assert_difference('Zombie.count') do
      post zombies_url, params: { zombie: { kills: @zombie.kills, picture: @zombie.picture, weapon: @zombie.weapon, weight: @zombie.weight } }
    end
  ...
  test "should update zombie" do
    patch zombie_url(@zombie), params: { zombie: { kills: @zombie.kills, picture: @zombie.picture, weapon: @zombie.weapon, weight: @zombie.weight } }
